    ...
    return (
        <Card sx={{ width: '408px', height: '751.38px', borderRadius: '20px',marginY:'1%', }} style={{ backgroundImage: `url(${product_image_src})`, }}>
            ...
            <CardContent sx={{display:'flex',alignContent:'space-between',flexWrap:'wrap',height:'100%',paddingY:'10%'}}>
                <Box sx={{width:'60%'}}>
                    <Typography gutterBottom variant="h5" component="div" sx={{ color: 'white', fontSize: '30px',fontFamily:'Montserrat',fontWeight:'600px' }}>
                        {product_name}
                    </Typography>
                </Box>
                <Box  sx={{width:'80%'}}>
                    ...
                    <Typography gutterBottom variant="h6" component="div" sx={{ color: 'white', fontSize: '15px',fontFamily:'Montserrat',fontWeight:'600px' }}>
                        {product_content}
                    </Typography>
                </Box>
